...
| 5 | **Wife's business awards** — free-only, Australia-only, education-first | **Drafting** (2026-08-04): verified $0 plan on the artifact page (perfect fit = ACEL Leadership Award; top 5 + kill list + 12-mo calendar); three nominations pre-drafted with placeholders (Telstra, ACEL letter, Most Influential Educators) | Eric/spouse: fill placeholder facts, pick the ACEL nominator, commit the Well-Nest files from the MacBook |
