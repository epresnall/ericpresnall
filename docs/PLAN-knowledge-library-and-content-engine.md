...
|---|------|--------|------------|
| 1 | **Second Brain in Notion** — consolidate VideoRep HQ, capture Eric's expertise, ingest sources, weekly learning loop | **ON HOLD** (Eric, 2026-08-04) — structure fully staged in docs/second-brain-build.md, voice guide + email playbook distilled and delivered; build deferred to later | Eric: revive when ready |
| 2 | **Topic research & avatar** — They Ask You Answer + YouTube SEO, social listening, channel audit | **DEFERRED** (Eric, 2026-08-04) — ICP decided (20–200, human-facing B2B); keywords/content diet/transcripts remain for later | Eric: revive when ready |
| 3 | **Awards review cadence** (VideoRep content) — map awards, build 50–100 item backlog, weekly reminder, five-things rating | **Research DONE** (memo delivered 2026-08-01): weekly cadence validated 3+ years; organize by video TYPE, tag by industry; cost-teardown format is an unclaimed gap; 20-episode starter backlog ready | Eric: reminder day/channel (Q3.2) + cold vs prep-sheet (Q3.6); then build backlog in Notion + weekly reminder |
| 4 | **Script-writing system** — research doc, tone & style guide, per-format templates | Not started | Tasks 1–2 |
| 5 | **Wife's business awards** — list of best-fit awards with dates + entry conditions (school-world coach/consultant, Sydney/NSW/AU) | **Research DONE** (entry plan delivered 2026-08-04): 7-program submit-first shortlist, 12-month calendar; nearest deadlines 28 Aug (Achiever) and 27 Sep (Women Changing the World, Sydney) | Eric: confirm 4 profile unknowns (suburb, mum y/n, ICF credential, memberships) + her details/results to draft entries |
