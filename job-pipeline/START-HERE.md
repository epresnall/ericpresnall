# ▶ START HERE — how to work this each morning
...
- `playbooks/` — reply→retainer + warm-intro scripts
- `application-pack.pdf` — printable flagship roles
- `loop-log.md` — running log of overnight improvement bursts
